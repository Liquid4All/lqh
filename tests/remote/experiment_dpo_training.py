...
Usage::
    ...
    python -m tests.remote.experiment_dpo_training --remote-host=toka
"""
...
if __name__ == "__main__":
    ...
    if not host:
        print("Usage: python -m tests.remote.experiment_dpo_training --remote-host=toka [--train-samples=200] [--eval-samples=200]")
        sys.exit(1)
